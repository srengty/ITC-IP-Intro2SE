...
<div style="text-align: right; font-style: italic; margin-bottom: 20px;">
    <p>Topic: Project Planning and Estimation.<br>
    Student learning time: 48 hours.</p>
</div>

# Lab 07 - Project planning and estimation
In this lab you will be asked to estimate and plan a whole project.  
The project can be selected from the list below or you can propose your own project (subject to approval).

**Programming Language**: Java  
**Platform**: Console application or Desktop application (JavaFX or Swing)  
**Deadline**: 4 weeks

**Important dates**:
  - Project planning submission: End of 1st week
  - Progress update submission and presentation: End of 2nd week or start of 3rd week
  - Final project submission and presentation: End of 4th week or start of 5th week

**Project selection**: non-redundancy.

**Plan**: Estimate the project using Top-down estimation.

**Detail plan**: Make detail estimation using bottom-up estimation.
...
10. **Attendance Dashboard**: Build a dashboard that can mark the attendance, listing attendees, sort, filter and allowing users to manage attendance records.
...
13. **Inventory Management System**: Build a console application for small businesses to track inventory levels, orders, sales, and deliveries.