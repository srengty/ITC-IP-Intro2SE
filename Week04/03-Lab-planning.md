...
<div style="text-align: right; font-style: italic; margin-bottom: 20px;">
    <p>Topic: Introduction to project planning.<br>
...
- issues with user stories created for each milestone.
- milestones created with due dates.
- labels created for categorizing user stories.
- source code repository initialized with a README file.
- .gitignore file added for your programming language.